...
type Task struct {
	Url    string `json:"url,omitempty"` //"http://mirrors.xxx.org/"
	...
	CheckIntvl   int64  `json:"ci,omitempty"`
	CheckLevel   int    `json:"cl,omitempty"`
}
...
type BusinessInfos struct {
	...
	CheckIntvl      int                `bson:"check_intvl"`
	CheckLevel      int                `bson:"check_level"`
}
